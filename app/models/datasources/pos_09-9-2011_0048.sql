...
--
-- Host: localhost
-- Generation Time: Sep 09, 2011 at 12:20 AM
...
INSERT INTO `clocks` VALUES(32, 21, 1, '2011-08-02 16:37:39', '2011-09-08 20:29:32', 0, 25.00, 22296.62, 0.00, '2011-08-02 16:37:39', '2011-09-08 20:29:38');
INSERT INTO `clocks` VALUES(33, 24, 0, '2011-09-08 20:29:49', '0000-00-00 00:00:00', 0, 10.00, 0.00, NULL, '2011-09-08 20:29:49', '2011-09-08 20:29:49');
...
INSERT INTO `discounts` VALUES(6, 16, 0, 0, 0, 1, 0, 0, 1, '10:00:00', '21:45:00', 2.09, 1, '2011-07-10 15:17:32', '2011-07-19 04:52:35');
...
CREATE TABLE `items` (
  ...
  `price` decimal(10,2) NOT NULL,
  `enable` tinyint(1) NOT NULL DEFAULT '1',
  `kitchen_print` tinyint(1) NOT NULL DEFAULT '1',
  `created` datetime NOT NULL,
  `modified` datetime NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `items` VALUES(1, 4, 'Single Steakburger', 'Single Stk', 'Plain, single burger.  Delicious with bacon.', 1, '', 3.69, 1, 1, '2011-01-18 18:57:57', '2011-01-29 21:37:10');
INSERT INTO `items` VALUES(2, 4, 'Frisco Melt', 'Frisco Mlt', 'Delicious.', 1, '', 5.19, 1, 1, '2011-01-18 21:23:28', '2011-01-18 22:11:04');
INSERT INTO `items` VALUES(3, 3, 'Country Scrambler', 'Country Scr', 'Eggs smothered in gravy', 1, '', 4.99, 1, 1, '2011-01-18 21:26:40', '2011-01-29 21:38:25');
INSERT INTO `items` VALUES(4, 4, 'Chicken Melt', 'Chicken Mlt', 'Delicious', 1, '', 5.29, 1, 1, '2011-01-29 15:08:48', '2011-01-29 21:38:33');
INSERT INTO `items` VALUES(5, 4, 'Apple Walnut Chicken Salad', 'Apl Walnut', 'Salad', 1, '', 5.99, 1, 1, '2011-01-29 15:09:15', '2011-01-29 21:39:04');
INSERT INTO `items` VALUES(6, 4, 'Triple Steakburger', 'Triple Stk', 'Big burger', 1, '', 4.99, 1, 1, '2011-01-29 15:10:17', '2011-01-29 21:39:23');
INSERT INTO `items` VALUES(7, 4, 'Turkey Club', 'Turkey Cl', 'Sandwich', 1, '', 4.89, 1, 1, '2011-01-29 15:12:15', '2011-01-29 21:39:34');
INSERT INTO `items` VALUES(8, 4, 'Chicken Finger Dinner', 'Chk Fn Dinner', 'Chicken fingers', 1, '', 5.49, 1, 1, '2011-01-29 15:13:42', '2011-01-29 21:40:12');
INSERT INTO `items` VALUES(9, 8, 'Coke', 'Coke', 'Coke', 0, '', 1.49, 1, 1, '2011-01-29 19:44:40', '2011-06-10 12:41:22');
INSERT INTO `items` VALUES(10, 3, 'French Toast', 'Fr Toast', 'French Toast topped with strawberries', 0, '', 3.99, 1, 1, '2011-01-29 23:29:16', '2011-01-29 23:29:16');
INSERT INTO `items` VALUES(11, 8, 'Sweet Tea', 'Sweet Tea', 'Sweet Tea', 0, '', 1.49, 1, 1, '2011-01-29 23:29:59', '2011-01-29 23:29:59');
INSERT INTO `items` VALUES(12, 8, 'Dr. Pepper', 'Dr. Pepper', 'Dr. Pepper', 0, '', 1.49, 0, 1, '2011-01-29 23:31:01', '2011-01-30 17:44:54');
INSERT INTO `items` VALUES(13, 7, 'Hot Fudge Sundae', 'HF Sundae', 'Hot Fudge Sundae', 0, '', 1.99, 1, 1, '2011-01-29 23:32:25', '2011-01-29 23:32:25');
INSERT INTO `items` VALUES(14, 8, 'Coffee', 'Coffee', 'Regular Coffee', 0, '', 1.29, 1, 1, '2011-01-29 23:34:08', '2011-01-29 23:34:08');
INSERT INTO `items` VALUES(15, 4, 'Spicy Chicken Sandwich', 'Spicy Chk', 'Spicy Chicken Sandwich', 1, '', 3.99, 1, 1, '2011-01-29 23:35:17', '2011-01-29 23:35:17');
INSERT INTO `items` VALUES(16, 4, 'Chili 3-way', 'Chili 3-way', 'Chili on Spaghetti Noodles', 0, '', 4.09, 1, 1, '2011-01-29 23:45:46', '2011-01-29 23:45:46');
INSERT INTO `items` VALUES(17, 4, 'Double Steakburger', 'Dbl Stk', 'Two steak patties on a bun.', 1, '', 3.89, 1, 1, '2011-01-30 17:10:18', '2011-01-30 17:10:18');
...
INSERT INTO `payments` VALUES(36, 186, 24, 17.47, 0.00, 'cash', '2011-09-08 21:14:18', '2011-09-08 21:14:18');
...
INSERT INTO `seats` VALUES(88, 165, 1, 0, '7(4:10:),9(),9(),', 7.37, NULL, NULL, '2011-06-29 17:37:50', '2011-06-29 17:37:50');
...
INSERT INTO `seats` VALUES(103, 172, 1, 0, '6(4:3:),14(),', 6.38, NULL, NULL, '2011-07-29 11:20:13', '2011-07-29 11:20:13');
INSERT INTO `seats` VALUES(102, 171, 1, 0, '9(),', 1.49, NULL, NULL, '2011-07-22 11:27:07', '2011-07-22 11:27:07');
INSERT INTO `seats` VALUES(104, 178, 1, 0, '16(),9(),', 3.48, NULL, NULL, '2011-08-02 11:02:24', '2011-08-02 11:02:24');
INSERT INTO `seats` VALUES(105, 183, 1, 1, '1(2:1:8:9:),11(),', 5.76, NULL, NULL, '2011-08-02 11:05:10', '2011-08-02 14:43:47');
INSERT INTO `seats` VALUES(106, 183, 2, 2, '16(),13(),', 3.98, NULL, NULL, '2011-08-02 11:05:10', '2011-08-02 14:43:47');
INSERT INTO `seats` VALUES(107, 184, 1, 0, '6(3:4:),', 5.09, NULL, NULL, '2011-08-02 15:58:54', '2011-08-02 15:58:54');
INSERT INTO `seats` VALUES(108, 185, 1, 0, '15(9:),', 4.28, NULL, NULL, '2011-08-02 16:10:45', '2011-08-02 16:10:45');
INSERT INTO `seats` VALUES(109, 186, 1, 0, '4(11:),14(),', 7.07, NULL, NULL, '2011-09-01 21:19:50', '2011-09-01 21:19:50');
INSERT INTO `seats` VALUES(110, 186, 2, 0, '8(3:),13(),11(),', 9.07, NULL, NULL, '2011-09-01 21:19:50', '2011-09-01 21:19:50');
INSERT INTO `seats` VALUES(111, 187, 1, 0, '15(10:2:),', 4.98, NULL, NULL, '2011-09-08 22:34:44', '2011-09-08 22:34:44');
...
CREATE TABLE `settings` (
  ...
  `kitchen_printer` varchar(255) NOT NULL,
  `use_gimme` tinyint(1) DEFAULT NULL,
  `locationid` int(15) DEFAULT NULL,
  `gimme_cert_location` varchar(255) DEFAULT NULL,
  `gimme_text` text,
  `gimme_url` varchar(255) DEFAULT NULL,
  `cc_process` tinyint(1) NOT NULL,
  `authorizenet_api_login_id` varchar(255) DEFAULT NULL,
  `authorizenet_transaction_key` varchar(255) DEFAULT NULL,
  `tax` decimal(10,4) NOT NULL DEFAULT '0.0000',
  `receiptdemo` tinyint(1) DEFAULT NULL,
  `created` datetime NOT NULL,
  `modified` datetime NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `settings` VALUES(1, 'Barnes POS Systems', '100 Main Street', 'Waco, TX 76706', '', '214-555-4444', '', 'www.barnespos.com', '', 1, 9, '/Users/Schwamm/Sites/barnespossystem/app/webroot/files/key.pem', 'Gimme HTML here', 'http://173.246.103.0:9000', 0, '', '', 8.2500, 1, '2011-06-08 13:33:57', '2011-09-08 23:27:24');
...
INSERT INTO `tickets` VALUES(187, 86, NULL, NULL, 24, NULL, 0, 3, 0, '2011-09-08 22:34:39', '2011-09-08 22:37:15');
INSERT INTO `tickets` VALUES(186, 85, NULL, NULL, 21, '22', 2, 1, 0, '2011-09-01 21:19:24', '2011-09-08 21:14:18');
...
INSERT INTO `users` VALUES(23, 'demo', 'Bill', 'Bob', '7c7faa99a475038db68b972eaebf4e037ead9e0d', 11111, 'info@barnespos.com', 1, 9.25, NULL, NULL, 1, '', '2011-06-29 18:58:47', '2011-08-02 12:28:46');
INSERT INTO `users` VALUES(24, 'barnespos', 'Barnes POS System', 'BPOS', '6bb7edbc51d3230e7ceb2330a78bfa86626300a2', 22222, '', 1, 10.00, NULL, NULL, 1, '', '2011-09-08 20:29:15', '2011-09-08 20:29:15');
