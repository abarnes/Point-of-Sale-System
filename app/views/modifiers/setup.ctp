...
<?php if ($check==true) { ?>
    ...
    <h3>Setup Utility -- Add Modifiers</h3>
    <p>Create your first modifier.  These are options that can be applied to your items, such as ketchup on a hot dog. You can choose the items for which the modifier is available, and temporarily disable an option by unchecking the "Enable" box.</p><br/>
    
    <table style="border:0px solid black;margin-right:auto;margin-left:auto;">
    
    <?php echo $form->create('Modifier', array('action' => 'setup')); ?>
...
<!--Create Other modifiers---------------------------------------->
    ...
    <h3>Setup Utility -- Add Modifiers</h3>
    <p>Create your modifiers.  These are options that can be applied to your items, such as ketchup on a hot dog.</p><br/>
    ...
    <div class="link">
        <a href="#" onclick="openadd()">Add Modifier</a>
    </div>
    <br/>
    ...
    <div id="add" title="Add Option">
        ...
        <table>
			...
			<?php
			echo '<input style="width:70px;height:28px;font-size:1em;margin:0px 4px 0px 0px;" type="button" class="submits" value="Edit" onclick="parent.location=\'/modifiers/edit/'.$u['Modifier']['id'].'/1\'">';
			echo '<input style="width:70px;height:28px;font-size:1em;margin:0px 4px 0px 0px;" type="button" class="submits" value="Delete" onclick="decision(\'/modifiers/delete/'.$u['Modifier']['id'].'/1\')">';
			?>
                    <?php //echo $html->link('Edit',array('action'=>'edit/'.$u['Modifier']['id'].'/1')); ?>
                    <?php /*echo $html->link(
                                        'Delete', 
                                        array('action'=>'delete/'.$u['Modifier']['id'].'/1'), 
                                        null, 
