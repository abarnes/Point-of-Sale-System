...
<a style="vertical-align:bottom;margin-left:0px;" href="#" onclick="submitform()"><input style="width:100%;margin-right:0px;height:44px;" type="button" class="submits" value="Submit"></a>
</div>
