...
<ul style="float:right;margin-top:5px;margin-bottom:8px;">
				...
				<li style="display:inline;margin:0px;"><a href="/tickets/inc_delete/<?php echo $id; ?>" onclick="return confirm('Are you sure you want to cancel this ticket?');"><input style="width:70px;height:40px;font-size:1em;position:relative;bottom:0px;margin:0px;" type="button" class="submits" value="Cancel"/></a></li>
</ul>
</div>
...
function submitform() {
  ...
  document.getElementById('SeatAdd<?php echo '/'.$id.'/'.$seats; ?>Form').submit();
}
</script>
