...
function enableInputs() {
  ...
  //$('#day-data-view').append('<div id="select-fix">&nbsp;</div>');
  //$('#month-data-view').append('<div id="select-fix">&nbsp;</div>');
}
...
(function($) {
    $.jQTouch = function(options) {
        ...
        function doNavigation(fromPage, toPage, animation, goingBack) {
            ...
            disableInputs(); // Kodamera edit to disable inputs to prevent ghost clicks
              $('#progress').css({
            ...
            function navigationEndHandler(event) {
                ...
                tapReady = true;
                var tt = setTimeout('enableInputs();', 500); // Kodamera edit to re-enable the inputs
                var timeout = setTimeout("$('#progress').fadeOut();",700)
        ...
        function hashChangeHandler(e) {
            _debug();
            //if (location.hash === hist[0].hash) {              keeps giving errors, edited out
